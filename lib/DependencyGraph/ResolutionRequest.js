  ...
  _createClass(ResolutionRequest, [{
    ...
    value: function _loadAsFile(potentialModulePath, fromModule, toModule) {
      ...
      return Promise.resolve().then(function () {
        if (_this6._helpers.isAssetFile(potentialModulePath) && !_this6._helpers.isGlob(potentialModulePath)) {
        ...
        if (_this6._helpers.isGlob(potentialModulePath)) {
          return _this6._moduleCache.getGlobModule(potentialModulePath);
        }
